let afisha = [
  ...
  },
  {
    ...
    description:
      'Вы прогуляетесь по вечерним улицам столицы разных эпох и затем посетите мастер-класс по изготовлению свечей.',
    duration: '1 час 20 минут',
    time: ['15:00']
  },
  {
    date: '15 мая, пятница',
    header: 'Презентация выставки страховых досок',
    description:
      'Куратор выставки Дмитрий Корнеев проведет авторскую экскурсию и расскажет о страховых досках отечественных и зарубежных компаний и их особенностях.',
